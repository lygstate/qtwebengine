...
get_filename_component(_realOrig "/lib/cmake/Qt5WebEngineCore" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5WebEngineCore_install_prefix "/lib/../" ABSOLUTE)
else()
...
set(Qt5WebEngineCore_VERSION_STRING 5.12.12)
...
if (NOT TARGET Qt5::WebEngineCore)
    ...
    set(Qt5WebEngineCore_PRIVATE_INCLUDE_DIRS
        "${_qt5WebEngineCore_install_prefix}/include/QtWebEngineCore/5.12.12"
        "${_qt5WebEngineCore_install_prefix}/include/QtWebEngineCore/5.12.12/QtWebEngineCore"
    )
    ...
    foreach(_module_dep ${_Qt5WebEngineCore_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.12.12 ${_Qt5WebEngineCore_FIND_VERSION_EXACT}
