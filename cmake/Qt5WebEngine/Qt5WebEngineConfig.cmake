...
get_filename_component(_realOrig "/lib/cmake/Qt5WebEngine" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5WebEngine_install_prefix "/lib/../" ABSOLUTE)
else()
...
set(Qt5WebEngine_VERSION_STRING 5.12.12)
...
if (NOT TARGET Qt5::WebEngine)
    ...
    set(Qt5WebEngine_PRIVATE_INCLUDE_DIRS
        "${_qt5WebEngine_install_prefix}/include/QtWebEngine/5.12.12"
        "${_qt5WebEngine_install_prefix}/include/QtWebEngine/5.12.12/QtWebEngine"
    )
    ...
    foreach(_module_dep ${_Qt5WebEngine_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.12.12 ${_Qt5WebEngine_FIND_VERSION_EXACT}
