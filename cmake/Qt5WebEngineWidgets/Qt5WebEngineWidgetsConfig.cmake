...
get_filename_component(_realOrig "/lib/cmake/Qt5WebEngineWidgets" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5WebEngineWidgets_install_prefix "/lib/../" ABSOLUTE)
else()
...
set(Qt5WebEngineWidgets_VERSION_STRING 5.12.12)
...
if (NOT TARGET Qt5::WebEngineWidgets)
    ...
    set(Qt5WebEngineWidgets_PRIVATE_INCLUDE_DIRS
        "${_qt5WebEngineWidgets_install_prefix}/include/QtWebEngineWidgets/5.12.12"
        "${_qt5WebEngineWidgets_install_prefix}/include/QtWebEngineWidgets/5.12.12/QtWebEngineWidgets"
    )
    ...
    set(_Qt5WebEngineWidgets_MODULE_DEPENDENCIES "WebEngineCore;QuickWidgets;Quick;Widgets;Gui;Network;Core")
    ...
    foreach(_module_dep ${_Qt5WebEngineWidgets_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.12.12 ${_Qt5WebEngineWidgets_FIND_VERSION_EXACT}
    ...
    set(_Qt5WebEngineWidgets_LIB_DEPENDENCIES "Qt5::WebEngineCore;Qt5::QuickWidgets;Qt5::Quick;Qt5::Widgets;Qt5::Gui;Qt5::Network;Qt5::Core")
